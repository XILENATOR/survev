...
function createClassCrate<T extends ObstacleDef>(e: Partial<T>): T {
    const t = {
        ...
        reflectBullets: false,
        loot: [tierLoot("tier_world", 1, 1)],
        map: { display: true, color: 11485471, scale: 1 },
        terrain: { grass: true, beach: true, riverShore: true },
        img: {
...
function createControlPanelCallie<T extends ObstacleDef>(e: Partial<T>): T {
    const t = {
        type: "obstacle",
        scale: { createMin: 1, createMax: 1, destroy: 0.8 },
        collision: collider.createAabbExtents(v2.create(0, 0), v2.create(1, 1)),
        ...
        sound: {
            bullet: "control_callie_hit",
            punch: "control_callie_hit",
            explode: "deposit_box_break_01",
            enter: "none",
        },
    };
...
function createFakeAirdrop<T extends ObstacleDef>(e: Partial<T>): T {
    const t = {
        obstacleType: "airdrop",
        dropCollision: collider.createAabbExtents(v2.create(0, 0), v2.create(2.5, 2.5)),
        collision: collider.createAabbExtents(v2.create(0, 0), v2.create(2.5, 2.5)),
...
export const MapObjectDefs: Record<string, MapObjectDef> = {
    ...
    savannah_patch_01: (function <T extends BuildingDef>(e: Partial<T>): T {
        const t = {
            ...
            mapObjects: [
                {
                    type: randomObstacleType({ crate_21: 2, class_crate_custom: 1 }),
                    pos: v2.create(0, 0),
                    scale: 1,
                    ori: 0,
                    inheritOri: false,
    ...
    bunker_twins_sublevel_01: {
        ...
        mapObjects: [
            ...
            {
                type: randomObstacleType({ recorder_14: 9, recorder_15: 1 }),
    ...
    class_crate_custom: createClassCrate({
        loot: [tierLoot("tier_scavenger_custom", 1, 1), tierLoot("tier_gear_custom", 1, 1),],
        img: { sprite: "map-class-crate-03.img" },
    }),
    control_panel_callie: createControlPanelCallie({
        collision: collider.createAabbExtents(v2.create(0, 0), v2.create(2.25, 1.7)),
        button: {
            interactionRad: 0.75,
            interactionText: "game-use",
            ...
            useDir: v2.create(1, 0),
            useImg: "map-control-panel-05.img",
            sound: { on: "cell_control_04", off: "cell_control_04" },
        },
        img: { sprite: "map-control-panel-04.img" },
    }),
    crate_21c: createCrate({
        health: 140,
        loot: [
            tierLoot("tier_cloud_01", 2, 3),
            tierLoot("tier_cloud_02", 1, 1),
            tierLoot("tier_dm_helmet", 1, 1),
        ],
        map: { display: true, color: 18799, scale: 0.875 },
        terrain: { grass: true, beach: false },
        img: { sprite: "img/map/map-crate-21c.svg" },
        sound: { explode: "crate_break_01" },
    }),
    crate_21d: createCrate({
        ...
        map: { display: true, color: 18799, scale: 0.875 },
        terrain: { grass: true, beach: false },
        img: { sprite: "img/map/map-crate-21d.svg" },
        sound: { explode: "crate_break_01" },
    }),
    savannah_patch_02: (function <T extends BuildingDef>(e: Partial<T>): T {
        const t = {
            type: "building",
            map: { display: true, shapes: [] },
            terrain: { grass: true, beach: false },
    ...
    savannah_patch_03: (function <T extends BuildingDef>(e: Partial<T>): T {
        const t = {
            type: "building",
            map: { display: true, shapes: [] },
            terrain: { grass: true, beach: false },
    ...
    airdrop_crate_fake: createFakeAirdrop({
        button: {
            useImg: "map-airdrop-02.img",
            useParticle: "airdropCrate01",
            sound: { on: "airdrop_open_01", off: "" },
        ...
        destroyType: "decal_frag_explosion",
        explodeParticle: "airdropCrate02",
    } as unknown as Partial<ObstacleDef>),
    barrel_01c: createBarrel({
        explosion: "explosion_fireworks",
        health: 200,
        map: { display: true, color: 11485424, scale: 1 },
        img: {
            sprite: "map-barrel-01.img",
            scale: 0.4,
            alpha: 1,
