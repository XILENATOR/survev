...
export const GameConfig = {
    ...
    player: {
        ...
        defaultItems: {
            ...
            scope: "1xscope",
            perks: [
                /*{ type: "endless_ammo", droppable: true },
                { type: "leadership", droppable: false },
                { type: "tree_climbing", droppable: false },*/
                { type: "splinter", droppable: false },
    ...
    bagSizes: {
        ...
        strobe: [2, 3, 4, 5, 6],
        mirv: [2, 4, 6, 8, 10],
        snowball: [10, 20, 30, 40, 60],
        potato: [10, 20, 30, 40, 60],
        bandage: [5, 10, 15, 30, 40],
        healthkit: [1, 2, 3, 4, 5],
        soda: [2, 5, 10, 15, 20],
        ...
        "30xscope": [1, 1, 1, 1, 1],
        "999xscope": [1, 1, 1, 1, 1],
        mirv_ultra: [1, 2, 3, 4, 5],
        golden_grenade: [1, 2, 3, 4, 5],
        launcher_frag: [0, 0, 0, 0, 0],
        fireworks: [1, 2, 3, 4, 5],
        launcher_mirv: [0, 0, 0, 0, 0],
        launcher_mirv_mini: [0, 0, 0, 0, 0],
    } as Record<string, number[]>,
    lootRadius: {
        outfit: 1,
        melee: 1.25,
