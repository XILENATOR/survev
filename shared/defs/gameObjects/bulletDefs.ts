...
export const BaseDefs: Record<string, BulletDef> = {
    ...
    bullet_laser_of_doom: {
        type: "bullet",
        damage: 72,
        obstacleDamage: 9999999,
        falloff: 0.1,
        distance: 1000,
        speed: 375,
        variance: 0,
    ...
    bullet_frag_inf: {
        ...
        tracerWidth: 0.1,
        tracerLength: 0.5,
        onHit: "explosion_usas_inf",
    },
    bullet_frag_extended: {
        type: "bullet",
        damage: 12,
        obstacleDamage: 1,
        falloff: 0.3,
    ...
    bullet_inferno: {
        ...
        tracerWidth: 0.25,
        tracerLength: 1,
        onHit: "explosion_inferno",
    },
    bullet_model94_ultra: {
        type: "bullet",
        damage: 66,
        obstacleDamage: 1,
        falloff: 0.75,
...
const SkinDefs: Record<string, BulletDef> = {
    ...
    bullet_vz61_bonus: defineBulletSkin("bullet_vz61", {
        speed: 106.25,
        distance: 125,
    }),
};
