...
export const ExplosionDefs: Record<string, ExplosionDef> = {
    ...
    explosion_launcher: {
        ...
        rad: { min: 5, max: 12 },
        shrapnelCount: 12,
        shrapnelType: "shrapnel_launcher",
        explosionEffectType: "frag",
        decalType: "decal_frag_explosion",
    },
    explosion_usas_inf: {
    ...
    explosion_fireworks: {
        ...
        rad: { min: 5, max: 12 },
        shrapnelCount: 6,
        shrapnelType: "bullet_frag_extended",
        explosionEffectType: "mirv",
        decalType: "decal_frag_explosion",
    },
    explosion_usas_extended: {
        type: "explosion",
        damage: 42,
        obstacleDamage: 4,
        rad: { min: 3.5, max: 6.5 },
        shrapnelCount: 2,
        shrapnelType: "bullet_frag",
        explosionEffectType: "usas",
        decalType: "decal_frag_small_explosion",
    },
    explosion_inferno: {
    ...
    explosion_split: {
        ...
        rad: { min: 0, max: 0 },
        shrapnelCount: 8,
        shrapnelType: "bullet_model94",
        explosionEffectType: "invisible",
        decalType: "",
    },
};
