...
const mapDef: PartialMapDef = {
    ...
    assets: {
        audio: [
            ...
            {name: "smoker_assigned_01", channel: "ui",},
        ...
        atlases: ["gradient", "loadout", "shared", "faction", "potato", "main"],
    },
    biome: {
        colors: {
            background: 333348,
...
export const PotatoFaction = util.mergeDeep({}, Faction, mapDef) as MapDef;
